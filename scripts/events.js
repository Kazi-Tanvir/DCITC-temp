...
const mockEvents = [
  {
    ...
    inPerson: false,
    description:
      "Join the world's largest tech gathering. Explore innovations in AI, cloud, and more.",
    image: "https://placehold.co/800x400/00b4db/0c0c14?text=Global+Tech+Conf",
    schedule: [
      { time: "09:00", title: "Opening Keynote", speaker: "Alex Chen" },
      { time: "10:30", title: "AI Ethics Panel", speaker: "Dr. Anya Sharma" },
    ],
    speakers: [
      {
        name: "Alex Chen",
        role: "CEO, Innovatech",
        image: "https://placehold.co/200x200/0083b0/ffffff?text=AC",
      },
      {
        name: "Dr. Anya Sharma",
        role: "AI Ethicist",
        image: "https://placehold.co/200x200/0083b0/ffffff?text=AS",
      },
    ],
  },
  {
    ...
    inPerson: true,
    description:
      "Master the principles of effective interface design with hands-on exercises.",
    image: "https://placehold.co/800x400/00b4db/0c0c14?text=UX/UI+Workshop",
    schedule: [
      { time: "10:00", title: "Intro to UX Principles" },
      { time: "13:00", title: "Prototyping Session" },
    ],
    speakers: [
      {
        name: "Ben Carter",
        role: "Lead Designer",
        image: "https://placehold.co/200x200/0083b0/ffffff?text=BC",
      },
    ],
  },
  {
    ...
    inPerson: false,
    description:
      "Discover how AI is transforming patient care, diagnostics, and drug discovery.",
    image: "https://placehold.co/800x400/00b4db/0c0c14?text=AI+Healthcare",
    speakers: [
      {
        name: "Dr. Eva Rostova",
        role: "Medical AI Researcher",
        image: "https://placehold.co/200x200/0083b0/ffffff?text=ER",
      },
    ],
  },
  {
    ...
    inPerson: true,
    description:
      "Network with local frontend developers, share projects, and discuss the latest trends.",
    image: "https://placehold.co/800x400/00b4db/0c0c14?text=Frontend+Meetup",
  },
  {
    id: 5,
    ...
    inPerson: false,
    description:
      "Learn about modern cloud infrastructure, serverless, and containerization.",
    image: "https://placehold.co/800x400/00b4db/0c0c14?text=Cloud+Workshop",
  },
  {
    id: 6,
    ...
    inPerson: true,
    description:
      "Protecting digital assets in an evolving threat landscape. Keynotes, workshops, and expo.",
    image: "https://placehold.co/800x400/00b4db/0c0c14?text=Cyber+Summit",
  },
  {
    id: 7,
    ...
    inPerson: false,
    description:
      "From theory to practical implementations using Python libraries.",
    image: "https://placehold.co/800x400/00b4db/0c0c14?text=ML+Workshop",
  },
  {
    id: 8,
    title: "Digital Marketing Trends Webinar",
    date: "2025-04-30",
    time: "11:00",
    duration: "1.5 hours",
    location: "Online",
    ...
    inPerson: false,
    description:
      "Stay ahead: Explore the latest strategies in SEO, content marketing, and social media.",
    image: "https://placehold.co/800x400/00b4db/0c0c14?text=Marketing+Trends",
  },
  {
    id: 9,
    ...
    inPerson: true,
    description:
      "Connect with founders, investors, and mentors in the local startup ecosystem.",
    image: "https://placehold.co/800x400/00b4db/0c0c14?text=Startup+Night",
  },
  {
    id: 10,
    ...
    inPerson: false,
    description:
      "Expert panel discusses remote work strategies, hybrid models, and employee well-being.",
    image: "https://placehold.co/800x400/00b4db/0c0c14?text=Future+of+Work",
  },
  {
    id: 11,
    ...
    inPerson: true,
    description:
      "Building the decentralized web: Explore blockchain, NFTs, DAOs, and the metaverse.",
    image: "https://placehold.co/800x400/00b4db/0c0c14?text=Web3+Conf",
  },
  {
    id: 12,
    ...
    inPerson: true,
    description:
      "The premier tech conference for innovators and entrepreneurs. Join us for three days of immersive learning and networking.",
    image: "https://placehold.co/800x400/00b4db/0c0c14?text=Innovation+Summit",
  },
];
...
function initializeParticles(elementId, interactive = false) {
  if (
    ...
    const config = {
      ...
      particles: {
        number: {
          value: elementId === "particles-js" ? 80 : 40,
        ...
        size: { value: elementId === "particles-js" ? 3 : 2.5, random: true },
        line_linked: {
          enable: true,
          distance: elementId === "particles-js" ? 150 : 120,
          color:
            elementId === "particles-js"
              ? "var(--primary-color)"
              : "var(--secondary-color)",
          opacity: elementId === "particles-js" ? 0.2 : 0.3,
          width: 1,
        },
        move: {
          enable: true,
          speed: elementId === "particles-js" ? 2 : 1.8,
          direction: "none",
          random: true,
          straight: false,
          out_mode: "out",
    ...
    config.particles.color.value = rootStyle
      .getPropertyValue(
        elementId === "particles-js" ? "--primary-color" : "--secondary-color"
      )
      .trim();
...
window
  ...
  .addEventListener("change", (event) => {
    if (!localStorage.getItem("theme")) {
      // Only change if user hasn't manually set
...
function setupEventListeners() {
  ...
  document
    ...
    .forEach((btn) => btn.addEventListener("click", handleSortFilter));
  document
    .querySelectorAll(".event-tag")
    .forEach((tag) => tag.addEventListener("click", handleTagFilter));
  document
  ...
  modalElement
    ...
    .forEach((btn) => btn.addEventListener("click", handleModalTabSwitch));
  document
  ...
  document
    ...
    ?.addEventListener("click", handleEventCardClick);
  document
    .getElementById("draggable-events")
    ?.addEventListener("click", handleEventCardClick);
  document
    .querySelector(".featured-events")
    ?.addEventListener("click", handleEventCardClick); // Add listener for featured event clicks
  document
    .querySelector(".draggable-prev")
    ?.addEventListener("click", () => scrollDraggable(-1));
  document
    .querySelector(".draggable-next")
    ?.addEventListener("click", () => scrollDraggable(1));
  setupDraggableScroll();
  document
    .getElementById("view-all-recommended")
    ?.addEventListener("click", (e) => {
      ...
      showNotification(
        "Showing All Events",
        "Filter reset to show all available events.",
        "info"
      );
    });
...
function handleEventCardClick(event) {
  ...
  const card = event.target.closest(
    ".event-card, .draggable-item, .standalone-event"
  );
...
function filterAndDisplayEvents() {
  ...
  const selectedSort =
    document.querySelector(".sort-btn.active")?.dataset.sort || "all";
  const selectedTag =
    document.querySelector(".event-tag.active")?.dataset.filter || "all";
  const searchQuery =
  ...
  mockEvents.forEach((event, index) => {
    ...
    const searchMatch =
      ...
      (event.description &&
        event.description.toLowerCase().includes(searchQuery)) || // Check if description exists
...
function checkTagFilter(event, filter) {
  ...
  if (filter === "upcoming")
    return DateTime.fromISO(event.date) >= DateTime.now().startOf("day");
...
function createEventCard(event, index) {
  ...
  if (
    ...
    card.onerror = () => {
      // Basic image error handling for background
  ...
  const formattedDate = eventDate.isValid
    ? eventDate.toFormat("LLL dd, yyyy")
    : "Date TBD";
  ...
  card.innerHTML = `
                 ...
                 <div class="event-content-main"> <h3 class="event-title">${
                   event.title
                 }</h3>
...
function isNewEvent(eventDateStr) {
  ...
  return (
    eventDate.isValid &&
    DateTime.now().diff(eventDate, "days").days <= 7 &&
    DateTime.now().diff(eventDate, "days").days >= 0
  );
}
...
function updateEventCount(count = null) {
  ...
  const currentCount =
    count ?? document.querySelectorAll("#events-grid .event-card").length;
...
function updateTagCounts() {
  ...
  tags.forEach((tag) => {
    ...
    if (filter === "all") {
      ...
      count = mockEvents.filter((event) =>
        checkTagFilter(event, filter)
      ).length;
    }
...
function renderCalendar() {
  ...
  for (let i = 0; i < firstDayWeekday; i++) {
    calendarGrid.insertAdjacentHTML(
      "beforeend",
      '<div class="calendar-day different-month"></div>'
    );
  }
  ...
  for (
    ...
    const eventsOnDay = mockEvents.filter((event) =>
      DateTime.fromISO(event.date).hasSame(day, "day")
    );
    if (eventsOnDay.length > 0) {
      dayElement.classList.add("has-events");
      dayElement.dataset.events = JSON.stringify(
        eventsOnDay.map((e) => ({
          id: e.id,
          title: e.title,
          time: e.time,
      ...
      if (eventsOnDay.length > 3) {
        eventsContainer.insertAdjacentHTML(
          "beforeend",
          `<div class="calendar-more-events">+${eventsOnDay.length - 3}</div>`
        );
      }
...
function getEventTypeColor(type) {
  ...
  const colors = {
    conference:
      rootStyle.getPropertyValue("--primary-color").trim() || "#00b4db",
    workshop: "#ff9f43",
    webinar: "#74b9ff",
    meetup: "#55efc4",
    social: "#a29bfe",
...
function createCalendarPopup(events) {
  ...
  events.slice(0, 4).forEach((event) => {
    ...
    popup.insertAdjacentHTML(
      ...
      `
        ...
        event.time
          ? `<span class="popup-time">${formatTime(event.time)}</span>`
          : ""
      }
  ...
  if (events.length > 4) {
    popup.insertAdjacentHTML(
      "beforeend",
      `<div class="popup-event"><p class="popup-title">... and ${
        events.length - 4
      } more</p></div>`
    );
  }
...
function changeMonth(offset) {
  currentCalendarDate = currentCalendarDate.plus({ months: offset });
  renderCalendar();
}
function goToToday() {
...
function openModal(eventData) {
  ...
  modalElement.querySelector(
    "#modal-event-date"
  ).textContent = `${DateTime.fromISO(eventData.date).toFormat("DDDD")} ${
    eventData.time ? `at ${formatTime(eventData.time)}` : ""
  }`;
  modalElement.querySelector("#modal-event-location").textContent =
    eventData.location;
  modalElement.querySelector("#modal-event-type").textContent =
    eventData.type.charAt(0).toUpperCase() + eventData.type.slice(1);
  modalElement.querySelector("#modal-event-description").textContent =
          ...
          .map(
            (item) => `
                     <div class="schedule-item">
                         <div class="schedule-time">${formatTime(
                           item.time
                         )}</div>
                         <div class="schedule-info">
                             ...
                             ${
                               item.speaker
                                 ? `<p class="schedule-speaker">${item.speaker}</p>`
                                 : ""
                             }
                         </div>
                     </div>`
          ...
          .map(
            (speaker) => `
                     <div class="speaker-card">
                         <img src="${
                           speaker.image ||
                           "https://placehold.co/200x200/cccccc/333333?text=?"
                         }" class="speaker-image" alt="${
              speaker.name
            }" loading="lazy" onerror="this.src='https://placehold.co/200x200/cccccc/333333?text=?'; this.onerror=null;">
  ...
  // Reset tabs to 'About'
  handleModalTabSwitch({
    currentTarget: modalElement.querySelector("#tab-btn-about"),
  });
...
function updateCountdown() {
  ...
  if (!summitEvent) {
    countdownContainer.innerHTML =
      "<span>Featured event details not found.</span>";
  ...
  if (diff.valueOf() <= 0) {
    countdownContainer.innerHTML =
      '<span style="font-weight: bold; color: var(--primary-color);">Event has started!</span>';
    ...
    document.getElementById("countdown-days").textContent = Math.floor(
      parts.days
    );
    document.getElementById("countdown-hours").textContent = Math.floor(
      parts.hours
    )
      .toString()
      .padStart(2, "0");
    document.getElementById("countdown-mins").textContent = Math.floor(
      parts.minutes
    )
      .toString()
      .padStart(2, "0");
    document.getElementById("countdown-secs").textContent = Math.floor(
      parts.seconds
    )
      .toString()
      .padStart(2, "0");
...
function populateDraggableEvents() {
  ...
  const upcomingEvents = mockEvents
    .filter(
      (event) =>
        DateTime.fromISO(event.date) >= DateTime.now().startOf("day") &&
        !event.featured
    ) // Filter upcoming, non-featured
    ...
    item.innerHTML = `
                     <div class="event-card-horizontal">
                         <div class="event-image" style="background-image: url('${
                           event.image ||
                           "https://placehold.co/300x180/cccccc/333333?text=Event"
                         }')" onerror="this.style.backgroundImage='url(https://placehold.co/300x180/cccccc/333333?text=Event)'"></div>
      ...
      event.time ? `@ ${formatTime(event.time)}` : ""
                             ...
                             <h4 class="event-title">${truncateText(
                               event.title,
                               35
                             )}</h4>
                             <p class="event-subtitle">${truncateText(
                               event.description,
                               45
                             )}</p>
                             <div class="event-footer">
...
function scrollDraggable(direction) {
  ...
  const cardWidth =
    container.querySelector(".draggable-item")?.offsetWidth || 330;
...
function showNotification(title, message, type = "info", duration = 4000) {
  ...
  const removeNotification = () => {
    ...
    notification.style.animation =
      "slideOutNotification 0.5s forwards ease-out";
...
try {
  ...
  for (let i = 0; i < styleSheet.cssRules.length; i++) {
    if (
      ...
      styleSheet.cssRules[i].name === "slideOutNotification"
    ) {
      hasSlideOut = true;
      break;
    }
  ...
  console.warn("Could not insert keyframe rule for slideOutNotification.", e);
}
